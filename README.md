...
jobs:
  release:
    ...
    steps:
      ...
      - uses: step-security/action-get-latest-tag@v1
        id: get-latest-tag
...
[actions-workflow-lint]: https://github.com/step-security/action-get-latest-tag/actions?query=workflow%3ALint
[actions-workflow-lint-badge]: https://img.shields.io/github/workflow/status/step-security/action-get-latest-tag/Lint?label=Lint&style=for-the-badge&logo=github
